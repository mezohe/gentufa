...
RuleReferenceExpression
  = name:IdentifierName args:(__ Parametrization)? !(__ (StringLiteral __)? "=") {
      return {
        type: "rule_ref",
        name: name,
...
Parametrization "parametrization"
  = "<" __ names:IdentifierNames ">" { return names }

IdentifierNames
  = (i:IdentifierName __ { return i })+
